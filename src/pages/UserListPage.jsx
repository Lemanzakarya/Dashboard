    ...
    <div>
        ...
        <div className="flex flex-col md:flex-row gap-3 md:gap-4 mb-4">
          <div className="relative flex-1 max-w-lg">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 border rounded-lg bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm placeholder-gray-400"
            />
          </div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between mt-6 gap-4">
        <div className="text-sm text-gray-600 dark:text-gray-400">
          Showing {Math.min((page + 1) * 5, filteredUsers)} of {filteredUsers}{" "}
          users {query && `(filtered from ${totalUsers} total)`}
        </div>
